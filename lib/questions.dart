...
class Question {
  ...
  List<Question> listeQuestions = [
    ...
    new Question('Le Commodore 64 est l\’ordinateur de bureau le plus vendu', true, '', 'quizz assets/commodore.jpg'),
    new Question('Le nom du drapeau des pirates est black skull', false, 'Il est appelé Jolly Roger', 'quizz assets/pirate.png'),
    ...
    new Question('Au Québec tire toi une bûche veut dire viens t\'asseoir', true, 'La bûche, fameuse chaise de bucheron', 'quizz assets/buche.jpg'),
    new Question('Le module lunaire Eagle possédait de 4Ko de Ram', true, 'Dire que je me plains avec mes 8GO de ram sur mon pc', 'quizz assets/eagle.jpg'),
  ];
